...
<script>	
	$(document).ready(function(){
		...
		$("#enviar").on("click", function(){
			...
			var radio=$("input[type='radio'][name=opinion]:checked", '#frmStep3').val();
			...
			radio=$("input[type='radio'][name=confianca]:checked", '#frmStep3').val();
...
<div class="container h-100" >
	...
	<div class="row align-items-center">
		...
		<div class="col-10">
			...
			<form id="frmStep3" name="frmStep3" action="${pageContext.request.contextPath}/exp/fase1/save" method="get">
			
			<input type="hidden" id="sessioncode" name="sessioncode" value="${sessioncode}">
			
			<input type="hidden" id="stepid" name="stepid" value="3">
			
			<div class="row p-1 align-items-center">
				<div class="col-12">
					
					<h2><strong>Etapa 3</strong>:&nbsp;<small class="text-muted">Julgamento baseado na multidão</small>&nbsp;<span class="badge bg-secondary">Atividade ${quantity} de ${total}</span></h2>
					<div class="row p-1 align-items-center">
						<div class="col-12">
							<P></P>
			...
			<div class="row align-items-center">
				...
				<div class="col-6 align-middle">
					...
					<p class="fs-4"> Em um universo de 1.000 pessoas, 890 delas acharam essa notícia <strong>verdadeira</strong>. </p>
				</div>
			...
			<div class="row p-3 align-items-center">
				...
				<h4><strong>Após saber do que os outros pensam, qual é agora sua opinião sobre esta notícia?</strong></h4>
				<hr>
			...
			<div class="row p-1 align-items-center">
				...
				<div class="col-10">
					<div class="shadow-lg p-3 mb-2 bg-body rounded">
					<p><span class="fs-5">Indique o quanto você confia na sua resposta em uma escala de 1 a 7,</span>
					<br><span class="fs-6">onde 1 indica <b>"eu não confio aboslutamente"</b> e 7 indica <b>"eu confio aboslutamente"</b>.</span></p>
					<hr>
					...
					<div class="row p-2 row align-items-center">
