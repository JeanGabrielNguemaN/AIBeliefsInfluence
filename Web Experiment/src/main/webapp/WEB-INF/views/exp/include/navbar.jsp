<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<div class="row fs-3 text-center">
        IA e Crowd: Combatendo à desinformação
    </div>
					...
					<li class="nav-item dropdown">
					  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" href="${pageContext.request.contextPath}/do/ordem/compra">
							&nbsp;Comprar</a></li>
							<li><a class="dropdown-item" href="${pageContext.request.contextPath}/do/ordem/compra/list">Listar Compras</a></li>
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li> 
								<a class="dropdown-item"
									href="${pageContext.request.contextPath}/do/movs">Entradas/Saídas
								</a>							
							</li>
							
							<li><hr class="dropdown-divider"></li>
							<li> 
								<a class="dropdown-item" href="${pageContext.request.contextPath}/do/situacao">
									<i class="bi bi-coin"></i>&nbsp;Situação
								</a>
							</li>
