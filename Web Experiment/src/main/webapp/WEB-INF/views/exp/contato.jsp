		...
		<div class="col-10">
			...
			<div class="row p-1 align-items-center">
				...
				<div class="bg-light">
					...
					<p class="fs-4">Os pesquisadores deste experimento pertencem ao PPGI (Programa de Pós-Graduação em Informática) da Universidade Federal do estado do Rio de Janeiro (UNIRIO), na linha de Pesquisa Sistemas Inteligentes Aplicados e Otimização. </p>
					<p class="fs-5">
					<ul class="fs-5">
