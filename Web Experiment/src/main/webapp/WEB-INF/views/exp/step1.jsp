		...
		<div class="col-10">
			...
			<div class="row p-1 align-items-center">
				<div class="col-12">
					...
					<h2><strong>Etapa 1</strong>:&nbsp;<small class="text-muted">Julgamento inicial</small>&nbsp;<span class="badge bg-secondary">Atividade ${quantity} de ${total}</span></h2>
					<div class="row p-1 align-items-center">
						<div class="col-12">
							<P></P>
			...
			<div class="row p-3 align-items-center">
				...
				<h4><strong>Qual sua opinião sobre esta notícia?</strong></h4>
				<hr>
