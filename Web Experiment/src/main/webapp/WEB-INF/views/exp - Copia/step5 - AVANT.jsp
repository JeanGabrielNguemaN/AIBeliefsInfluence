...
<div class="container h-100" >
	...
	<div class="row row align-items-center">
		...
		<div class="col-10">
			...
			<form name="frmRegister" action="${pageContext.request.contextPath}/exp/fase1/save" method="get">
			
			<input type="hidden" id="sessioncode" name="sessioncode" value="${sessioncode}">
			
			<input type="hidden" id="stepid" name="stepid" value="5">
			
			<div class="row p-3 align-items-center">
				<div class="col-12">
					
					<h3><span class="badge bg-secondary">Etapa 5:&nbsp;Revisão do julgamento&nbsp;<span class="badge bg-secondary">Atividade ${quantity} de ${total}</span></h3>
