		...
		<div class="col-10">
			...
			<div class="row p-2 align-items-center">
				<div class="col-12">
					...
					<h3>Etapa 2:&nbsp;Seu julgamento&nbsp;<span class="badge bg-secondary">Atividade ${quantity} de ${total}</span></h3>
			...
			<div class="row p-2 align-items-center">
				...
				<h5>Agora sabendo dessa informação da IA, qual é sua opinião sobre esta notícia?</h5>
				<hr>
			...
			<div class="row h-25  row align-items-center">
				...
				<button id="enviar" type="submit" class="btn btn-primary btn-lga">Avançar</button>
