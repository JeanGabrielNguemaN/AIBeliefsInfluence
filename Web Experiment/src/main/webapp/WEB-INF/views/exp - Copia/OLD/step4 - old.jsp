...
<div class="container h-100" >
	...
	<div class="row h-25  row align-items-center">
		...
		<div class="col-10">
			...
			<form name="frmRegister" action="${pageContext.request.contextPath}/exp/fase4/save" method="get">
			
			<div class="row p-3 align-items-center">
				<div class="col-12">
					
					<h3><span class="badge bg-secondary">Etapa 4:&nbsp;Revisão do julgamento&nbsp;<span class="badge bg-secondary">Atividade ${quantity} de ${total}</span></h3>
