...
<div class="container h-100" >
	...
	<div class="row align-items-center">
		...
		<div class="col-10">
			...
			<form name="frmStep2" action="${pageContext.request.contextPath}/exp/fase1/save" method="get">
			...
			<div class="row p-2 align-items-center">
				<div class="col-12">
					...
					<h3>Etapa 3:&nbsp;Seu julgamento&nbsp;<span class="badge bg-secondary">Atividade ${quantity} de ${total}</span></h3>
