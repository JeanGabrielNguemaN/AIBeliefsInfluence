	...
	<div class="row  h-25 align-items-center">
		<div class="row  h-50 align-items-center">
			...
			<div class="col-9 h-100 alert p-3 alert-danger d-flex align-items-center" role="alert">
			  ...
			  <div class="fs-5">
				<stronger>${errorMsg}</stronger> 
				Por gentileza, relate esse problema aos pesquisadores: mvojgnn@edu.unirio.br.
			  </div>
			</div>
		...
		<div class="row  h-50 align-items-center">
			...
			<div class="col-9 h-100 text-center">
			
				<br><br>
			   <div>
				
				<a class="fs-4" href="${pageContext.request.contextPath}/exp/">Página inicial</a>
			  </div>
			</div>
